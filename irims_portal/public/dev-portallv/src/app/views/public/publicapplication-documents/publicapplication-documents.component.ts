...
@Component({
  selector: 'app-publicapplication-documents',
  templateUrl: './publicapplication-documents.component.html',
  styleUrls: ['./publicapplication-documents.component.css']
})
export class PublicapplicationDocumentsComponent  implements OnInit {
  ...
  onApplicationDocumentToolbar(e) {
    ...
    e.toolbarOptions.items.unshift({
      ...
      widget: 'dxButton',
      options: {
        text: 'Press the Upload option to upload (Multiple Documents Can be Uploaded)',
        type: 'default'
      }
    }, {
        location: 'after',
