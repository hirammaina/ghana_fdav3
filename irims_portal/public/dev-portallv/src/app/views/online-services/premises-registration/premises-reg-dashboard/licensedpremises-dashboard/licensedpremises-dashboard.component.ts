...
@Component({
  selector: 'app-licensedpremises-dashboard',
  templateUrl: './licensedpremises-dashboard.component.html',
  styleUrls: ['./licensedpremises-dashboard.component.css']
})
export class LicensedpremisesDashboardComponent implements OnInit {
  contextMenu:any;
