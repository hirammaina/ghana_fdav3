        ...
        this.registered_premisesData.store = new CustomStore({
          load: function (loadOptions: any) {
            console.log(loadOptions)
              ...
              this.configData = {
                  headers: headers,
                  params: {skip: loadOptions.skip,take:loadOptions.take, searchValue:loadOptions.filter,table_name:'tra_premises_applications',mistrader_id:me.mistrader_id ,trader_id:me.trader_id }
              };
