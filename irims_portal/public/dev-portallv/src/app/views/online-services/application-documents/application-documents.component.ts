...
export class ApplicationDocumentsComponent implements OnInit {
  ...
  @Input() preview_allonlinedocuploads: boolean;
 ...
 // appDocumentsUploadData:any;
  ...
  constructor(public modalServ: ModalDialogService, public viewRef: ViewContainerRef, public spinner: SpinnerVisibilityService, public configService: ConfigurationsService, public router: Router, public formBuilder: FormBuilder, public config: ConfigurationsService, public modalService: NgxSmartModalService, public toastr: ToastrService, public authService: AuthService, public dmsService: DocumentManagementService, public utilityService: Utilities,private cd: ChangeDetectorRef,public httpClient: HttpClient) { }
  ngOnInit() {
  ...
  onLoadApplicationDocUploads() {
    ...
    let action_params = { document_type_id: document_type_id, application_code: this.application_code, section_id: this.section_id, sub_module_id: this.sub_module_id,status_id:this.status_id,query_ref_id:this.query_ref_id,prodclass_category_id:this.prodclass_category_id,preview_allonlinedocuploads:this.preview_allonlinedocuploads,premise_type_id:this.premise_type_id,gmp_type_id:this.gmp_type_id,importexport_permittype_id:this.importexport_permittype_id}; 
    this.dmsService.onLoadApplicationDocploads(action_params,'getApplicationDocploads')
      ...
      .subscribe(
        data => {
          ...
          if (response_data.success) {
            this.appDocumentsUploadData =   response_data.data;

          }
          else {
            this.toastr.error(response_data.message, 'Alert');
          }
