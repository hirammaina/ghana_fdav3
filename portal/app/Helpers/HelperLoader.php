...
if (!function_exists('generatePremisesReferenceNo')) {
    function generatePremisesReferenceNo($section_id,$sub_module_id)
    {
        return ReferencingHelper::generatePremisesReferenceNo($section_id,$sub_module_id);
    }
}
...
if (!function_exists('checkForOngoingApplications')) {
    function checkForOngoingApplications($registered_id, $table_name, $reg_column, $process_id,$sub_module_id = null)
    {
        return UtilityHelper::checkForOngoingApplications($registered_id, $table_name, $reg_column, $process_id,$sub_module_id);
    }
}if (!function_exists('checkForPortalOngoingApplications')) {
    function checkForPortalOngoingApplications($registered_id, $table_name, $reg_column, $process_id,$sub_module_id = null)
    {
        return UtilityHelper::checkForPortalOngoingApplications($registered_id, $table_name, $reg_column, $process_id,$sub_module_id);
    }
}
