            ...
            $app_previousdata = DB::connection('mis_db')->table($applications_table)
                        ...
                        $app_status_id = $app_status->status_id;
                                $application_details = array(
                                    ...
                                    'application_type_id'=>$results-> application_type_id,
                                    'psu_no'=>$results->psu_no,
                                    'applied_for'=>$results->applied_for,
									...
									//'producttype_defination_id' => $results->producttype_defination_id,
									...
									// 'reason_for_importation'=>$results->reason_for_importation, 
