...
public function gmpProductLinkedLineDataRows(Request $request)
    {
        ...
        try {
           ...
           ->select('t1.*','t1.id as record_id', 't2.id as product_line_id', 't3.id as gmp_product_categories_id', 't2.name as product_line_name', 't3.name as product_line_category','t2.name as product_line', 't1.product_line_description','t2.gmp_product_categories_id',
