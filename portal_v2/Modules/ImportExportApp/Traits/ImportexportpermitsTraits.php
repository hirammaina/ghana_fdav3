	 ...
	 function funcSaveOnlineImportExportOtherdetails($application_code, $user_id)
    {
		...
		if($record >0){
           ...
           $previous_permitdetails = DB::table('wb_permits_products as t2')
                                       ...
                                       ->select(DB::raw(
                                        "approvedlicense_product_id, approvedvisa_product_id, is_registered, reference_no, ingredient_id,specification_type_id, number_of_primary_packs,number_of_units_packs,unit_cost_per_unit, consignment_quantity,visa_quantity,controlleddrug_base,controlleddrug_baseunit_id,pack_unit,strength_asgrams,drugs_content,gramsbasesiunit_id,controlleddrugs_basesalt_id,controlled_drugssubstances_id,controlleddrugs_type_id,purpose_of_drugsuse,ctrdrugslicense_permits_drugs_id,conversion_unit,product_strength,country_oforigin_id,prodcertificate_no,country_oforigin_id, manufacturer_name,consignment_quantity,visa_quantity,product_batch_no,product_expiry_date,product_manufacturing_date,regulated_prodpermit_id, permitbrand_name, common_name,dosage_form, section_id, unitpack_size,unitpack_unit_id,prodclass_category_id,productphysical_description,product_registration_no,document_upload_id,manufacturer_id,permitcommon_name,is_regulated_product,laboratory_no,device_type_id,product_id,quantity,unit_price,currency_id,application_code,packaging_unit_id,product_packaging,total_weight,weights_units_id,product_category_id,id as portal_id, now() as created_on"
                                    ))
