...
*/
        ...
        controller: {
            '*': {
               ...
               previewControlDrugsOnlineApplication:'previewControlDrugsOnlineApplication',
                 ...
                 editSpreadhsheetpreviewPermitinformation:'editSpreadhsheetpreviewPermitinformation',
    ...
    funcPrintInspectionImportExportPermit:function(btn){
        var me = this,
         is_preview = btn.is_preview,
            ...
            var action_url = 'reports/genenerateInspectionLicensePermit?application_code=' + application_code + '&module_id=' + module_id+ '&is_preview=' + is_preview;
    ...
    batchInspectionProductsrodrecommendtion:function(btn){
        ...
        application_id = activeTab.down('hiddenfield[name=active_application_id]').getValue(),
        application_code = activeTab.down('hiddenfield[name=active_application_code]').getValue(),
        permitsproductsgrid = activeTab.down('#poeinspectionpermitsproductsgrid');
    ...
    onIntiateLicenseInspectionApplication:function(view, record) {
        var mainTabPnl = this.getMainTabPanel(),
            ...
            grid = view.up('grid');
            Ext.MessageBox.confirm('Initiate Inspection Process', 'Do you want to initiate Inspection for the selected License '+$reference_no+'?', function (button) {
                if (button === 'yes') {
                                ...
                                if (success == true || success === true){
                                    ...
                                    if (permit_details) {
                                        var  results = resp.results,
                                          ...
                                          win.close();
                                          containerPnl.down('displayfield[name=application_status]').setValue(permit_details.application_status);
                
                                        containerPnl.down('displayfield[name=reference_no]').setValue(permit_details.reference_no);
                                        containerPnl.down('displayfield[name=tracking_no]').setValue(permit_details.tracking_no);
                                        containerPnl.down('hiddenfield[name=active_application_code]').setValue(permit_details.application_code);
            ...
            success: function (response) {
                ...
                if (success == true || success === true) {
                   ...
                   permitsdetails_panel.add({xtype:'previewproductDocUploadsGrid',title: 'Application Uploaded Documents (All)'});
                    ...
                    permitsdetails_panel.add({xtype:'applicationunstructuredqueriesgrid',title: 'Request for Additional Information(Queries)'});
                    queries_panel = permitsdetails_panel.down('applicationunstructuredqueriesgrid');
...
/*
    ...
    funcsetApplicatonTitle:function(pnl,sub_module_id){
        if(sub_module_id == 12){
            ...
            var application_title = 'Official Certificate (Import of Controlled Drugs)';
