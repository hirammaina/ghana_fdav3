Ext.define("Admin.controller.ClinicalTrialCtr", {
  ...
  config: {
    ...
    control: {
      ...
      //SAVE
      "receivingsafetyalertreportswizard button[name=save_btn]": {
        //new
        click: "saveReceivingSafetyAlertReportsDetails",
      },
      "safetyalertreportsassessmentappmoredetailswizard button[name=save_btn]":
        {
          //new
          click: "saveSafetyalertReportsassessmentappmoredetails",
        },
      "newclinicaltrialreceivingwizard button[name=save_btn]": {
        //new
        click: "saveClinicalTrialNewReceivingBaseDetails",
      },
      "preclinicaltrialreceivingwizard button[name=save_btn]": {
        //new
        click: "saveClinicalTrialNewReceivingBaseDetails",
      },
      "amendmentclinicaltrialreceivingwizard button[name=save_btn]": {
        //amendment
        click: "saveClinicalTrialAmendmentReceivingBaseDetails",
      },
      "preclinicaltrialreceivingwizard button[name=save_clinicaltrial_details_btn]":
        {
          //new
          click: "saveNewApplicationClinicalTrialDetails",
        },

      "newclinicaltrialreceivingwizard button[name=save_clinicaltrial_details_btn]":
        {
          //new
          click: "saveNewApplicationClinicalTrialDetails",
        },
      "amendmentclinicaltrialreceivingwizard button[name=save_clinicaltrial_details_btn]":
        {
          //amendment
          click: "saveClinicalTrialAmendmentReceivingBaseDetails",
        },
      "clinicaltrialappmoredetailswizard button[name=save_btn]": {
        //more details win wizard
        click: "updateClinicalTrialNewReceivingBaseDetails",
      },
      "ctrprogressreportappmoredetailswizard button[name=save_clinicaltrial_details_btn]":
        {
          //more details win wizard
  ...
  listen: {
    controller: {
      "*": {
        ...
        clinicalApplicationMoreDetails:
          "showClinicalTrialApplicationMoreDetailsGeneric",
        showSafetyAlertApplicationMoreDetails:
          "showSafetyAlertApplicationMoreDetails",
        previewClinicalTrialApplicationOnGridDetails:
          "previewClinicalTrialApplicationOnGridDetails",
        previewClinicalApplicationMoreDetails:
          "showClinicalTrialApplicationMoreDetails",
        previewOnlineClincialTrialApplication:
          "previewOnlineClincialTrialApplication",
        showClinicalTrialRegistryMoreDetails:
          "showClinicalTrialRegistryMoreDetails",
  ...
  onRegisteredProductGridDoubleClick: function (
    view,
    record,
    item,
    index,
    ...
    mask.show();
    form
      .down("textfield[name=product_registration_no]")
      .setValue(record.get("certificate_no"));
    form.down("textfield[name=brand_name]").setValue(record.get("brand_name"));
    form
      .down("textfield[name=generic_name]")
      .setValue(record.get("common_name"));
    form
      .down("combo[name=dosage_form_id]")
      .setValue(record.get("dosage_form_id"));
    form
      .down("textfield[name=product_strength]")
      .setValue(record.get("product_strength"));

    form
      .down("textfield[name=manufacturer_id]")
      .setValue(record.get("manufacturer_id"));

    form
      .down("textfield[name=marketing_authorisation_holder]")
      .setValue(record.get("applicant_name"));

    form
      .down("textfield[name=marketing_authorisation_address]")
      .setValue(record.get("applicant_name_address"));
    form
      .down("textfield[name=local_technical_representative]")
      .setValue(record.get("local_technical_representative"));
  ...
  funcsaveClinicalTrialRegDetails: function (btn) {
    ...
    (activeTab = btn.up("#clinicaltrialregistrypreviewpnl")),
      ...
      (applicant_id = applicantDetailsForm
  ...
  loadClinicalTrialRegistryEditApp: function (grid, record) {
    ...
    var me = this,
      ...
      ctrregistryeligibilitycriteriafrm = pnl.down(
        "ctrregistryeligibilitycriteriafrm"
      ),
    ...
    activeTab
      .down("hiddenfield[name=active_application_id]")
      .setValue(record.get("active_application_id"));
    activeTab
    ...
    activeTab
      ...
      .setValue(record.get("application_status_id"));
    activeTab
    ...
    activeTab
      .down("textfield[name=reference_no]")
  ...
  showCTRGcpInspectionApplicationSubmissionWin: function (btn) {
    ...
    var mainTabPanel = this.getMainTabPanel(),
      ...
      inspection_id = activeTab
        ...
        .getValue(),
      leadInspectorDetails = inspectorsStore.findRecord("role_id", 1); //Job from 2
  ...
  showCTRGcpInspectionSelection: function (btn) {
    ...
    if (id != "") {
      ...
      toastr.warning(
        "Please save GCP Inspection Details before Registered Clinical Trial Selection!!",
        "Warning Response"
      );
    }
  },
  ...
  previewOnlineClincialTrialApplication: function (view, record) {
    ...
    if (sub_module_id == 23) {
      var onlinePanel = Ext.widget("clinicaltrialprogressrptonlinepreviewpnl"),
        wizardPnl = onlinePanel.down(
          "clinicaltrialprogressrptonlinepreviewwizard"
        );
    } else if (sub_module_id == 56) {
      var onlinePanel = Ext.widget("clinicaltrialonlineregistrypreviewpnl"),
        wizardPnl = onlinePanel.down(
          "clinicaltrialonlineregistrypreviewwizard"
        );
      panel_width = "95%";
    } else {
      ...
      if (
        ...
        //pre checking and manager query response
        wizardPnl.down("button[name=preview_queries_btn]").setVisible(true);
      }

      onlinePanel
        .down("clinicaltrialsponsorfrm")
        .down("button[action=search_btn]")
        .setDisabled(true);
      onlinePanel
        .down("clinicaltrialinvestigatorfrm")
        .down("button[action=search_btn]")
        .setDisabled(true);
    }
  ...
  pharmacovigilancereportingHome: function () {
    var me = this,
      mainTabPanel = me.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab(),
      dashboardWrapper = activeTab.down(
        "pharmacovigilancereportingdashwrapper"
      );
  ...
  showAddClinicalTrialRegistrySponsor: function (btn) {
    ...
    childObject.setUI(childObject.ui + "-framed");
    childObject
      .down("hiddenfield[name=personnel_type]")
      .setValue("ctrregistrysponsor");
    funcShowCustomizableWindow(
      winTitle,
      winWidth,
      childObject,
  ...
  showAddImpProduct: function (btn) {
    ...
    (childObject = Ext.widget(btn.childXtype)),
      ...
      (application_id = activeTab
        ...
        .getValue()),
      (section_id = activeTab.down("hiddenfield[name=section_id]").getValue()),
      (dosageFormsStr = childObject
        .down("combo[name=dosage_form_id]")
        .getStore()),
      (commonNamesStr = childObject
        .down("combo[name=common_name_id]")
        .getStore()),
      (manufacturersStr = childObject
        .down("combo[name=manufacturer_id]")
        .getStore()),
      (filters = {
  ...
  showAddImpProductIngredient: function (btn) {
    var winTitle = btn.winTitle,
      ...
      inclusionStr = childObject
        .down("combo[name=inclusion_reason_id]")
        .getStore(),
      filters = {
        section_id: section_id,
      };
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          if (toaster == 1 || toaster === 1) {
            ...
            activeTab.down("displayfield[name=reference_no]").setValue(ref_no);
            activeTab
              .down("button[action=search_application]")
              .setDisabled(true);
  ...
  saveNewApplicationClinicalTrialDetails: function (btn) {
    ...
    (application_id = activeTab
      ...
      (investigator_id = investigatorForm
        .down("hiddenfield[name=id]")
        .getValue());
  ...
  prepareReceivingSafetyAlertReportsWizard: function () {
    ...
    if (activeTab.down("combo[name=applicable_checklist]")) {
      var app_check_types_store = activeTab
  ...
  prepareNewClinicalTrialInvoicing: function () {
    ...
    var me = this,
      ...
      premise_details = otherDetailsFrm.down(
        "displayfield[name=premise_details]"
      ),
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            activeTab
              ...
              .setValue(results.manufacturing_site_id);
            activeTab
              .down("hiddenfield[name=applicant_id]")
              .setValue(results.applicant_id);
            if (
  ...
  prepareSafetyalertreportsassessment: function () {
    ...
    var me = this,
      ...
      activeTab = mainTabPanel.getActiveTab(),
      detailsFrm = activeTab.down("safetyalertreportsdetailsfrm"),
      safetyalertreportsobservationsgrid = activeTab.down(
        "safetyalertreportsobservationsgrid"
      ),
      safetyalertreportsassessmentappmoredetailswizard = activeTab.down(
        "safetyalertreportsassessmentappmoredetailswizard"
      ),
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
  ...
  prepareNewClinicalTrialAssessment: function () {
    ...
    var me = this,
      ...
      clinicaltrialotherinvestigatorsstr = Ext.getStore(
        "clinicaltrialotherinvestigatorsstr"
      ),
      ...
      sponsorFrm = activeTab.down("clinicaltrialsponsorfrm"),
      investigatorFrm = activeTab.down("clinicaltrialinvestigatorfrm"),
      clinicaltrialappmoredetailswizard = activeTab.down(
        "clinicaltrialappmoredetailswizard"
      ),
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            if (results) {
              ...
              applicantFrm
                .down("button[action=link_applicant]")
                .setDisabled(true);
  ...
  prepareCtrProgressReportAssessment: function () {
    ...
    var me = this,
      ...
      clinicaltrialappmoredetailswizard = activeTab.down(
        "ctrprogressreportappmoredetailswizard"
      ),
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
  ...
  prepareNewClinicalTrialManagerMeeting: function () {
    ...
    this.prepareClinicalTrialMeetingDetailsGeneric(
      activeTab,
      applicationsGrid,
      0
    );
  ...
  prepareClinicalTrialMeetingDetailsGeneric: function (
    activeTab,
    applicationsGrid,
    isReadOnly
  ) {
  ...
  prepareClinicalTrialComparePreview: function (pnl) {
    var me = this,
      ...
      portal_application_id = portalPnl
        .down("hiddenfield[name=application_id]")
        .getValue(),
      mis_application_id = misPnl
        .down("hiddenfield[name=application_id]")
        .getValue(),
      mask = new Ext.LoadMask({
        target: pnl,
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            if (portalInvestigatorDetails) {
              var model2 = Ext.create(
                "Ext.data.Model",
                portalInvestigatorDetails
              );
      ...
      widgetCol.widget.menu.items = [
        {
          ...
          hidden:
            Admin.global.GlobalVars.checkForProcessVisibility("actual_delete"),
        },
      ];
    }
  },
  ...
  onClinicalTrialPersonnelDbClick: function (view, record) {
    ...
    if (personnel_type == "sponsor" || personnel_type == "investigator") {
      ...
      this.addClinicalTrialClinicalRegistrySponsor(
        view,
        record,
        personnel_type
      );
  ...
  addClinicalTrialSponsorInvestigator: function (view, record, personnel_type) {
    ...
    } else if (personnel_type == "investigator") {
  ...
  validateNewSaftyAlertReceivingSubmission: function (btn) {
    ...
    if (!detailsFrm.isValid()) {
      toastr.warning(
        "Please Enter All the required Clinical Trial Details!!",
        "Warning Response"
      );
      return false;
    }
  ...
  validateNewClinicalTrialReceivingSubmission: function (btn) {
    var mainTabPanel = this.getMainTabPanel(),
      ...
      applicant_id = applicantFrm
        .down("hiddenfield[name=applicant_id]")
        .getValue(),
      sponsor_id = activeTab
        .down("clinicaltrialsponsorfrm")
        .down("hiddenfield[name=id]")
        .getValue(),
      investigator_id = activeTab
        .down("clinicaltrialinvestigatorfrm")
        .down("hiddenfield[name=id]")
        .getValue(),
      screeningGrid = activeTab.down("productscreeninggrid"),
    ...
    if (!investigator_id) {
      toastr.warning(
        "Please Select Principal Investigator!!",
        "Warning Response"
      );
      return false;
    }
  ...
  showNewScreeningApplicationSubmissionWin: function (btn) {
    ...
    var validate_documentrecom =
      validateDocumentsSubmissonRecRecommendation(application_code);
    if (!hasQueries) {
      if (!validate_documentrecom) {
        Ext.getBody().unmask();
        toastr.warning(
          "Please Enter The Application Documents Submission recommendation!!",
          "Warning Response"
        );
        return false;
      }
  ...
  showNewAssessmentApplicationSubmissionWin: function (btn) {
    ...
    hasEvalUploadChecklist = checkApplicationChecklistUploadDetails(
      application_code,
      module_id,
      sub_module_id,
      section_id,
    ...
    if (!hasEvalUploadChecklist) {
      toastr.warning(
        "Upload the evaluation/assessment report or fill in the Evaluation checklist details(for checklist based evaluation) to proceed!!",
        "Warning Response"
      );
      Ext.getBody().unmask();
      return false;
  ...
  showNewAuditingApplicationSubmissionWin: function (btn) {
    ...
    var mainTabPanel = this.getMainTabPanel(),
      ...
      application_code = activeTab
        ...
        .getValue(),
      hasQueries = checkApplicationRaisedQueries(application_code, module_id),
      hasRespondedUnclosedQueries = checkApplicationRespondedUnclosedQueries(
        application_code,
        module_id
      ),
      valid = true,
    ...
    if (hasRespondedUnclosedQueries > 0) {
      Ext.getBody().unmask();
      toastr.warning(
        "Please close responded queries to proceed!!",
        "Warning Response"
      );
      return false;
    }
  ...
  showGCPInspectionDetailsWizard: function (
    application_id,
    inspectiondetails_pnl,
    app_inspection_id,
    application_code,
    applicant_id,
    ref_no,
    ...
    (recommendationform = wizardPnl.down("gcpinspectionrecommendationfrm")),
      (recommendationfrm = wizardPnl
        .down("gcpinspectionrecommendationfrm")
        .getForm());
      ...
      Ext.Ajax.request({
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            (respCol = child
              .getColumnManager()
              .getHeaderByDataIndex("last_response")),
              (managerQryCol = child
                .getColumnManager()
                .getHeaderByDataIndex("manager_query_comment")),
              (managerQryRespCol = child
                .getColumnManager()
                .getHeaderByDataIndex("manager_queryresp_comment"));
  ...
  showSafetyAlertApplicationMoreDetails: function (
    application_id,
    application_code,
    applicant_id,
    ref_no,
    ...
    var me = this,
      mainTabPanel = me.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab(),
      applicationdetails_panel =
        activeTab.down("#main_processpanel").applicationdetails_panel;
    ...
    var detailsFrm = wizardPnl.down("safetyalertreportsdetailspnl"),
      previewproductDocUploadsGrid = wizardPnl.down(
        "clinicaltrialdocuploadsgenericgrid"
      );
  ...
  showClinicalTrialApplicationMoreDetailsGeneric: function (
    ...
    wizardPnl = Ext.create("Ext.tab.Panel", {
      ...
      items: [
        {
          xtype: applicationdetails_panel,
          title: "Clinical Application Details ",
        },
      ],
    });
  ...
  onClinicalTrialSelectionListDblClick: function (
    view,
    record,
    item,
    index,
  ...
  getApplicationClinicalTrialDetailsOnSelect: function (
    activeTab,
    previous_id
  ) {
    Ext.getBody().mask("Please wait...");
  ...
  showPreviousUploadedDocs: function (btn) {
    var me = this,
      ...
      static_stage = getClinicalTrialModuleStaticStage(
        sub_module_id,
        section_id,
        target_stage
      );
    this.fireEvent(
      "showPrevUploadedDocsWin",
      btn,
      section_id,
      module_id,
      sub_module_id,
