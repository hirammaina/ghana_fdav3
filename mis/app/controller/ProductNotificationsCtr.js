...
Ext.define("Admin.controller.ProductNotificationsCtr", {
  ...
  listen: {
    controller: {
      "*": {
        editpreviewProductNotificationInformation:
          "editpreviewProductNotificationInformation",
      },
    },
  },
  beforeProductNotificationAppsGridDeselect: function (
    sel,
    record,
    index,
    eOpts
  ...
  showProductNptificationApplicationMoreDetails: function (btn) {
    ...
    this.showProductnotificationMoreDetailsGeneric(
      productdetails_panel,
      application_id,
      product_id,
      applicant_id,
  ...
  showProductnotificationMoreDetailsGeneric: function (
    productdetails_panel,
    application_id,
    product_id,
    applicant_id,
