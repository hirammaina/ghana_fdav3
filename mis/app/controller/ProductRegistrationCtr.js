...
Ext.define("Admin.controller.ProductRegistrationCtr", {
  ...
  config: {
    ...
    control: {
      ...
      onlineproductretentionsreqreceivingwizard: {
      ...
      legacyprocessproductapprovalgrid: {
        refresh: "alterationproductapprovalRefreshgrid",
      },
    },
  },
  ...
  init: function () {
    ...
    stores.forEach((store) => {
      var store1 = Ext.create(store);
      Ext.data.StoreManager.register(store1);
    });
  },
    ...
    controller: {
      "*": {
        ...
        showReceivingApplicationSubmissionWin:
          "showReceivingApplicationSubmissionWin",
        showSamplerecApplicationSubmissionWin:
          "showSamplerecApplicationSubmissionWin",
        ...
        getBatchApplicationApprovalDetails:
          "getBatchApplicationApprovalDetails",
        ...
        showPreviousNonGridPanelUploadedDocs:
          "showPreviousNonGridPanelUploadedDocs",
        ...
        previewQueryResponseOnlineApplication:
          "previewQueryResponseOnlineApplication",
  ...
  onChangeProdClassCategoryDetails: function (cbo, value) {
    ...
    this.funchelperChangeOnProdCategory(
      category_id,
      is_medical_devices,
      section_id,
      frm
  ...
  funchelperChangeOnProdCategory: function (
    category_id,
    is_medical_devices,
    section_id,
    frm
    ...
    if (section_id == 2 || section_id == 7) {
      ...
      if (section_id == 1 || section_id == 9) {
        frm.down("textfield[name=nicotine_content]").setVisible(false);
        frm.down("textfield[name=tar_content]").setVisible(false);
        frm.down("combo[name=tobacco_flavour_id]").setVisible(false);
        frm.down("button[name=btn_addtobaccoflavous]").setVisible(false);
      } else {
        frm.down("textfield[name=nicotine_content]").setVisible(true);
        frm.down("textfield[name=tar_content]").setVisible(true);
        frm.down("combo[name=tobacco_flavour_id]").setVisible(true);
        frm.down("button[name=btn_addtobaccoflavous]").setVisible(true);
      }
      //18
    } else if (
      section_id == 3 ||
      ...
      if (category_id == 2) {
        ...
        frm
          .down("textfield[name=shelf_lifeafter_reconstitution]")
          .setVisible(false);
        ...
        frm
          .down("textarea[name=descriptionofmethod_ofshelflife]")
          .setVisible(true);
        frm.down("combo[name=intended_enduser_id]").setVisible(false);
        frm
          .down("textfield[name=storage_conditionafter_opening]")
          .setVisible(false);
        ...
        // frm.down('combo[name=who_class_id]').setVisible(false); 8
  ...
  previewQueryResponseOnlineApplication: function (view, record) {
    ...
    onlinePanel
      .down("hiddenfield[name=last_query_ref_id]")
      .setValue(last_query_ref_id);
  ...
  onRegisteredProductsgridDblClick: function (grid, record) {
    ...
    if (activeTab.down("hiddenfield[name=is_populate_primaryappdata]")) {
      is_populate_primaryappdata = activeTab
        .down("hiddenfield[name=is_populate_primaryappdata]")
        .getValue();
    }
    (filter = { section_id: section_id }),
      (workflow_stage_id = activeTab
        ...
        .getValue());
    if (sub_module_id == 7 || sub_module_id == 8) {
      app_check_types_store = activeTab
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            if (is_populate_primaryappdata == 1) {
              activeTab
                .down("hiddenfield[name=active_application_code]")
                .setValue(results.active_application_code);
              activeTab
                .down("hiddenfield[name=active_application_id]")
              ...
              activeTab
                ...
                .setValue(results.tra_product_id);
  ...
  getApplicationApprovalDetails: function (item) {
    ...
    if (is_update > 0) {
      ...
      form
        .down("button[name=save_recommendation]")
        .setText("Update Recommendation");
    }
  ...
  drugsProductsDetailsFrmDefination: function (frm) {
    ...
    //onChangeProdClassCategoryDetails
    if (frm.up("window")) {
      section_id = frm
        .up("window")
        .down("hiddenfield[name=section_id]")
  ...
  editpreviewGmpProductInformation: function (item) {
    ...
    (isReadOnly = item.isReadOnly),
      ...
      (process_id = record.get("process_id")),
      (appdata_ammendementrequest_id = record.get(
        "appdata_ammendementrequest_id"
      )),
      (workflow_stage_id = activeTab
        .down("hiddenfield[name=workflow_stage_id]")
        .getValue());
  ...
  editpreviewProductInformation: function (item) {
    ...
    if (activeTab.down("#main_processpanel")) {
      productdetails_panel =
        activeTab.down("#main_processpanel").productdetails_panel;
    } else {
      if (section_id == 2) {
        productdetails_panel = "drugsProductsDetailsPanel";
      } else {
  ...
  previewproductApplicationQueries: function (item) {
    ...
    (isReadOnly = item.isReadOnly),
      ...
      (activeTab = mainTabPanel.getActiveTab()),
      (productqueriespanel =
        activeTab.down("#main_processpanel").productqueriespanel),
      (application_id = record.get("active_application_id")),
      (product_id = record.get("product_id")),
      (section_id = record.get("section_id")),
      (applicant_id = record.get("applicant_id")),
  ...
  funcPrevAuditReportUpload: function (item) {
    ...
    if (section_id == 4 || prodclass_category_id == 2) {
      ...
      var url =
        "reports/generateProductAuditReport?application_code=" +
        application_code +
        "&sub_module_id=" +
        sub_module_id;
      print_report(url);
  ...
  funcPrevEvaluationReportUpload: function (item) {
    ...
    if (section_id == 4 || prodclass_category_id == 2) {
      ...
      var url =
        "reports/generateProductEvaluationReport?application_code=" +
        application_code +
        "&sub_module_id=" +
        sub_module_id;
      print_report(url);
  ...
  showProductApplicationMoreDetailsGeneric: function (
    ...
    isReadOnly,
    is_temporal,
    appdata_ammendementrequest_id = null
  ) {
    Ext.getBody().mask("Please wait...");
    var mainTabPanel = this.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab();
    ...
    if (isReadOnly && (isReadOnly == 1 || isReadOnly === 1)) {
      if (sub_module_id != 67) {
        if (productdetails_panel.down("button[name=save_btn]")) {
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          if (prodclass_category_id == 2) {
            ...
            product_panel.add({ xtype: "antisepticproductsdetailsfrm" });
          }
          ...
          if (sub_module_id == 9) {
            productdetails_panel.add({
              xtype: "productsvariationrequestsgrid",
              title: "Product Variation Requests",
            });

            productdetails_panel
              .down("productsvariationrequestsgrid")
              .down("hiddenfield[name=application_code]")
              .setValue(application_code);
            productdetails_panel
              .down("productsvariationrequestsgrid")
          ...
          if (sub_module_id == 17) {
            ...
            productdetails_panel
              .down("productswithdrawalreasonsgrid")
              .down("hiddenfield[name=application_code]")
              .setValue(application_code);
            productdetails_panel
              .down("productswithdrawalreasonsgrid")
          ...
          if (sub_module_id == 20) {
            ...
            productdetails_panel
              .down("productdataappealrequestsgrid")
              .down("hiddenfield[name=application_code]")
              .setValue(application_code);
            productdetails_panel
              .down("productdataappealrequestsgrid")
          ...
          if (is_dataammendment_request == 1) {
            productdetails_panel.add({
              ...
              title: "DATA AMMENDMENT REQUESTS",
            });
            productdetails_panel
              .down("productdataammendmentrequestsgrid")
              .down("hiddenfield[name=application_code]")
              .setValue(application_code);
            productdetails_panel
              .down("productdataammendmentrequestsgrid")
          ...
          documents_grid = productdetails_panel.down(
            "previewproductDocUploadsGrid"
          );
          documents_grid
            .down("hiddenfield[name=process_id]")
  ...
  prepareProductMeetingDetailsGeneric: function (
    activeTab,
    applicationsGrid,
    isReadOnly
  ) {
  ...
  saveTCMeetingDetails: function (btn) {
    var mainTabPanel = this.getMainTabPanel(),
      ...
      section_id = activeTab.down("hiddenfield[name=section_id]").getValue(),
      applicationsStore = activeTab
        .down("productManagerMeetingGrid")
        .getStore(),
      selected = [];
    Ext.each(selected_records, function (item) {
      selected.push(item.data.application_code);
  ...
  showApplicationMoreDetails: function (btn) {
    ...
    this.applicationProductMoreDetailsGeneric(
      application_id,
      product_id,
      applicant_id,
      ref_no,
  ...
  applicationProductMoreDetailsGeneric: function (
    application_id,
    premise_id,
    applicant_id,
    ref_no,
  ...
  funcSelectgmpInspectionDetailsGrid: function (grid, record) {
    ...
    (producmanufacturer_form = me.getproductManuctureringFrm()),
      (gmp_productlineStr = producmanufacturer_form
        .down("combo[name=gmp_productline_id]")
        .getStore());

    gmp_productlineStr.removeAll();
    gmp_productlineStr.load({
  ...
  funcSaveproductManufacturedetails: function (
    btn,
    producmanufacturer_form,
    me
  ) {
          ...
          if (success == true || success === true) {
            ...
            if (producmanufacturer_form) {
              if (is_manufacturingsite == 1) {
                producmanufacturer_form
                  .down("textfield[name=manufacturing_site]")
                  .setValue(response.manufacturer_name);
                producmanufacturer_form
                  .down("hiddenfield[name=man_site_id]")
                  .setValue(response.manufacturer_id);
                producmanufacturer_form
                  .down("textfield[name=physical_address]")
                  .setValue(response.physical_address);
              } else {
                producmanufacturer_form
                  .down("textfield[name=manufacturer_name]")
                  .setValue(response.manufacturer_name);
                producmanufacturer_form
                  .down("hiddenfield[name=manufacturer_id]")
                  .setValue(response.manufacturer_id);
                producmanufacturer_form
                  .down("textfield[name=physical_address]")
                  .setValue(response.physical_address);
  ...
  prepareNewProductPayments: function () {
    ...
    var me = this,
      ...
      product_details = otherDetailsFrm.down(
        "displayfield[name=product_details]"
      ),
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
  ...
  prepareApplicationBaseDetails: function (tab, record) {
    ...
    tab
      .down("hiddenfield[name=active_application_id]")
      .setValue(application_id);
    var application_code_field = tab.down(
  ...
  prepareNewProductReceiving: function () {
    ...
    var me = this,
      ...
      section_id = activeTab.down("hiddenfield[name=section_id]").getValue(),
      zone_cbo = activeTab.down("combo[name=zone_id]"),
      assessment_procedure = activeTab.down(
  ...
  prepareEvalResponseOnlineProductReceiving: function (pnl) {
    ...
    (application_status_id = activeTab
      ...
      (sub_module_id = activeTab
        ...
        .getValue()),
      (section_id = activeTab.down("hiddenfield[name=section_id]").getValue()),
      (status_type_id = activeTab
        .down("hiddenfield[name=status_type_id]")
        .getValue()),
      (application_code = activeTab
        .down("hiddenfield[name=application_code]")
        .getValue()),
      (last_query_ref_id = activeTab
        .down("hiddenfield[name=last_query_ref_id]")
        .getValue()),
      (zone_cbo = activeTab.down("combo[name=zone_id]"));
    (filter = { section_id: section_id }),
    ...
    var checklist_gridpanel = activeTab.down("panel[name=checklist_gridpanel]"),
      querieschecklistgrid = checklist_gridpanel.down(
        "productapplicationqueriesgrid"
      );

    querieschecklistgrid.show();
    querieschecklistgrid
      .down("hiddenfield[name=application_code]")
      .setValue(application_code);
    querieschecklistgrid
      .down("hiddenfield[name=last_query_ref_id]")
    ...
    pnl
      .getViewModel()
      .set("prechecking_querytitle", "EVALUATION QUERY RESPONSES");
  ...
  prepareOnlineProductReceiving: function (pnl) {
    ...
    if (status_type_id == 3) {
      var checklist_gridpanel = activeTab.down(
          "panel[name=checklist_gridpanel]"
        ),
        productonlinescreeninggrid = checklist_gridpanel.down(
  ...
  prepareRenAltProductReceiving: function () {
    ...
    (application_status_id = activeTab
      ...
      .getValue()),
      (stores =
        '["dosageformstr", "assessmentprocedurestr", "classificationstr","commonnamesstr","siunitstr","distributionCategoryStr","storageconditionstr","routeofAdministrationStr","routeofAdministrationStr"]'),
      ...
      Ext.Ajax.request({
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            if (sub_module_id == 17) {
              activeTab
                .down("combo[name=withdrawal_type_id]")
                .setValue(results.withdrawal_type_id);
            } else if (sub_module_id == 20) {
              activeTab
                .down("combo[name=appeal_type_id]")
                .setValue(results.appeal_type_id);
            }
          } else {
            toastr.error(message, "Failure Response");
          }
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            if (activeTab.down("productdataammendmentrequestsgrid")) {
              activeTab
                .down("hiddenfield[name=appdata_ammendementrequest_id]")
                .setValue(results.appdata_ammendementrequest_id);
              activeTab
                .down("productdataammendmentrequestsgrid")
                .down("hiddenfield[name=application_code]")
                .setValue(application_code);
            ...
            me.setApplicationDetailsAlterationSetup(
              application_code,
              results.appdata_ammendementrequest_id,
              product_panel
            );
          } else {
            toastr.error(message, "Failure Response");
  ...
  setApplicationDetailsAlterationSetup: function (
    application_code,
    appdata_ammendementrequest_id,
    productapp_panel
  ) {
  ...
  prepareNewProductSampleReceiving: function () {
    ...
    (application_status_id = activeTab
      ...
      (process_id = activeTab.down("hiddenfield[name=process_id]").getValue()),
      (section_id = activeTab.down("hiddenfield[name=section_id]").getValue()),
      (applicant_details = activeTab.down(
        "displayfield[name=applicant_details]"
      )),
      (local_agentdetails = activeTab.down(
        "displayfield[name=local_agentdetails]"
      )),
      (filter = { section_id: section_id }),
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            applicant_details.setValue(
              results.applicant_name + ", " + results.app_physical_address
            );
            if (ltrResults) {
              local_agentdetails.setValue(
                ltrResults.applicant_name +
                  ", " +
                  ltrResults.app_physical_address
              );
            }
  ...
  onApplicantSelectionListDblClick: function (
    view,
    record,
    item,
    index,
  ...
  showSamplerecApplicationSubmissionWin: function (btn) {
    ...
    if (!hasQueries) {
      if (!validate_documentrecom) {
        Ext.getBody().unmask();
        toastr.warning(
          "Please Enter The Product Application Documents Submission recommendation!!",
          "Warning Response"
        );
        return false;
      }
    ...
    showWorkflowSubmissionWin(
      ...
      application_code,
      table_name,
      "workflowsubmissionsstrictrecommfrm",
      winWidth,
      storeID,
      extraParams,
      "",
  ...
  showManagerEvaluationApplicationSubmissionWin: function (btn) {
    ...
    if (valid == true || valid === true) {
      showWorkflowSubmissionWin(
        ...
        application_code,
        table_name,
        "drugworkflowsubmissionsmanevafrm",
        winWidth,
        storeID,
        "",
        "",
  ...
  showEvaluationApplicationSubmissionWin: function (btn) {
    ...
    var mainTabPanel = this.getMainTabPanel(),
      ...
      sub_module_id = activeTab
        ...
        .getValue(),
      section_id = activeTab.down("hiddenfield[name=section_id]").getValue(),
      hasRecommendation = checkApplicationEvaluationOverralRecom(
        application_code,
        2
      ),
      hasQueries = checkApplicationRaisedQueries(application_code, module_id),
    ...
    if (!hasRecommendation) {
      toastr.warning(
        "Enter the Assessment Overrall Recommendation to Proceed!!",
        "Warning Response"
      );
      Ext.getBody().unmask();
      return false;
    ...
    if (section_id == 3 || sub_module_id == 8 || sub_module_id == 9) {
      ...
      if (activeTab.down("combo[name=applicable_checklist]")) {
        checklist_category_id = activeTab
          .down("combo[name=applicable_checklist]")
          .getValue();
      }
      ...
      if (!hasEvalUploadChecklist || templateSaved == 1) {
        toastr.warning(
          "Upload the evaluation report or fill in the Evaluation checklist details(for checklist based evaluation) to proceed!!",
          "Warning Response"
        );
        Ext.getBody().unmask();
        return false;
  ...
  showAuditingApplicationSubmissionWin: function (btn) {
    ...
    var mainTabPanel = this.getMainTabPanel(),
      ...
      storeID = getApplicationStore(module_id, section_id);
    hasQueries = checkApplicationUnstructuredQueries(
      application_code,
      module_id
    );
    ...
    if (!hasRecommendation) {
      toastr.warning(
        "Enter the 2nd Assessment Overrall Recommendation to Proceed!!",
        "Warning Response"
      );
      Ext.getBody().unmask();
      return false;
    ...
    if (!form.isValid()) {
      toastr.warning(
        "Enter all the product application details to proceed!!",
        "Warning Response"
      );
      Ext.getBody().unmask();
      return false;
    ...
    if (valid == true || valid === true) {
      showRecommendationWorkflowSubmissionWin(
        application_id,
        application_code,
        table_name,
        "workflowsubmissionsstrictrecommfrm",
  ...
  prepareDrugsProductsUploadQueryPanel: function () {
    ...
    activeTab
      .down("drugsmanagerproductsqueriesgrid")
      .down("hiddenfield[name=application_code]")
      .setValue(application_code);
      ...
      Ext.Ajax.request({
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            if (activeTab.down("button[name=upload_evaluationreport]")) {
              activeTab
                .down("button[name=upload_evaluationreport]")
                .setVisible(false);
            }
