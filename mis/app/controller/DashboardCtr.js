...
Ext.define('Admin.controller.DashboardCtr', {
    ...
    stores: [
        ...
        'Admin.store.dashboard.QuerySubmissionsTraytaskStr',
        'Admin.store.dashboard.SummaryIntrayGridStr',
        'Admin.store.dashboard.CompletedTrayTaskStr',
        'Admin.store.dashboard.TrackingInTrayStr',
        'Admin.store.dashboard.UserTrayCompletedTasksGridStr',
        'Admin.store.dashboard.TrackingSummaryIntrayGridStr',
