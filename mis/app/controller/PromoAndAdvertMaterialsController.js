Ext.define("Admin.controller.PromoAndAdvertMaterialsController", {
  ...
  listen: {
    controller: {
      "*": {
        ...
        setCustomPromotionMaterialGridsStore:
          "setCustomPromotionMaterialGridsStore",
        showPromotionAndAdvertsApplicationMoreDetailsOnDblClick:
          "showApplicationMoreDetailsGeneric",
        ...
        customShowApplicationMoreDetailsGeneric:
          "customShowApplicationMoreDetailsGeneric",
        ...
        previewOnlinePromotionalApplication:
          "previewOnlinePromotionalApplication",
        getPromotionBatchApplicationApprovalDetails:
          "getPromotionBatchApplicationApprovalDetails",
      },
    },
  },
  ...
  refreshPromotionalApplicationDashgrid: function (grid) {
    ...
    workflow_stage_id = activeTab
      .down("combo[name=workflow_stage_id]")
      .getValue();
    store = grid.store;
  ...
  preparePromotionAndAdvertsDetailsWizard: function (pnl) {
    ...
    (applicantFrm = activeTab.down("promotionalapplicantdetailsfrm")),
      (promLocalapplicantdetailsfrm = activeTab.down(
        "promLocalapplicantdetailsfrm"
      )),
  ...
  onNewPromotionMaterials: function (sub_module_id, section_id, xtypeWrapper) {
    ...
    var me = this,
      ...
      dashboardWrapper = activeTab.down(
        /* '#promotionmaterialswrapper' */ xtypeWrapper
      ),
      module_id = activeTab.down("hiddenfield[name=module_id]").getValue(),
      // section_id = activeTab.down('hiddenfield[name=section_id]').getValue(),
      filter = { section_id: section_id };
  ...
  onApplicantSelectionListDblClick: function (
    ...
    if (grid.applicantType === "nonlocal") {
      ...
      applicantForm
        .down("textfield[name=applicant_sponsor_name]")
        .setValue(record.get("sponsor_name"));
      applicantForm
        .down("hiddenfield[name=sponsor_id]")
  ...
  onRegisteredProductGridDoubleClick: function (
    ...
    form
      .down("textfield[name=registration_no]")
    ...
    form
      ...
      .setValue(record.get("common_name_id"));
    form
      .down("textfield[name=registrant_name]")
  ...
  validatePromotionMaterialReceivingSubmission: function (btn) {
    var mainTabPanel = this.getMainTabPanel(),
      ...
      applicant_id = applicantFrm
        ...
        .getValue(),
      promotiommaterialproductgrid = activeTab.down(
        "promotiommaterialproductgrid"
      ),
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
    ...
    if (
      promotiommaterialproductgrid.getStore().getModifiedRecords().length > 0
    ) {
      toastr.warning(
        "There are unsaved product particulars info!!",
        "Warning Response"
      );
      return false;
    }
  ...
  saveApplicantPromotionMaterialsDetails: function (btn) {
    ...
    (containerPnl = mainTabPnl.getActiveTab()),
      ...
      (section_id = containerPnl
        .down("hiddenfield[name=section_id]")
        .getValue()),
      (zone_id = 2), // containerPnl.down('combo[name=zone_id]').getValue(),
      ...
      (checkapplication_id = containerPnl
        .down("hiddenfield[name=active_application_id]")
        .getValue()),
      (promotionalappdetailsfrm = containerPnl.down(
        "promotionalappdetailsfrm"
      )),
      (promotionmaterialsdocuploadsgenericgrid = containerPnl.down(
        "promotionmaterialsdocuploadsgenericgrid"
      )),
      (promotiommaterialproductgrid = containerPnl.down(
        "promotiommaterialproductgrid"
      )),
      (promotionapplicantdetailsfrm = containerPnl.down(
        "promotionalapplicantdetailsfrm"
      )),
      (applicant_id = promotionapplicantdetailsfrm
        .down("hiddenfield[name=applicant_id]")
        .getValue());
    (promLocalapplicantdetailsfrm = containerPnl.down(
      "promLocalapplicantdetailsfrm"
    )),
      (local_agent_id = promLocalapplicantdetailsfrm
        .down("hiddenfield[name=applicant_id]")
        .getValue());
  ...
  prepareNewPromotionMaterialPayments: function () {
    ...
    var me = this,
      ...
      promotion_materials_details = otherDetailsFrm.down(
        "displayfield[name=promotion_materials_details]"
      ),
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            activeTab
              ...
              .setValue(results.application_id);
            activeTab
              .down("hiddenfield[name=applicant_id]")
            ...
            promotion_materials_details.setValue(
              results.promotion_materials_id
            );
          } else {
            toastr.error(message, "Failure Response");
          }
  ...
  preparePromotionAndAdvertsEvaluation: function () {
    ...
    var me = this,
      ...
      workflow_stage_id = activeTab
        .down("hiddenfield[name=workflow_stage_id]")
        .getValue(),
      app_check_types_store = activeTab.down(
        "combo[name=applicable_checklist]"
      ).store,
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
  ...
  showApplicationMoreDetails: function (btn) {
    ...
    this.showApplicationMoreDetailsGeneric(
      application_id,
      application_code,
      section_id
    );
  ...
  customShowApplicationMoreDetailsGeneric: function (record, show_portal_btns) {
    ...
    var me = this,
      ...
      activeTab = Ext.create("Ext.tab.Panel", {
        layout: "fit",
        items: [
          {
            xtype: childXtype,
            title: "Promotional & Advertisements Application Details ",
          },
        ],
      }),
      wizardPnl = activeTab;
      ...
      Ext.Ajax.request({
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            wizardPnl
              .down("displayfield[name=application_status]")
              .setValue(record.get("application_status"));
            wizardPnl
              .down("displayfield[name=tracking_no]")
              .setValue(record.get("tracking_no"));
            ...
            wizardPnl
              .down("hiddenfield[name=application_id]")
              .setValue(record.get("application_id"));
            wizardPnl
  ...
  showApplicationMoreDetailsGeneric: function (
    application_id,
    application_code,
    section_id
  ) {
  ...
  deleteRecordFromIDComplex: function (
    id,
    table_name,
    storeID,
    url,
  ...
  deleteRecordSingleParam: function (
    id,
    table_name,
    storeID,
    url,
  ...
  showEvaluationMoreDetails: function (btn) {
    this.customShowApplicationMoreDetailsGeneric(
      btn.up("promotionadvertsevaluationdocpanel").record
    );
  },
