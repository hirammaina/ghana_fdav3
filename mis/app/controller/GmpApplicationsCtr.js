...
Ext.define("Admin.controller.GmpApplicationsCtr", {
  ...
  config: {
    ...
    control: {
      ...
      //end
      "newgmpreceivingwizard button[name=save_btn]": {
        //new
        click: "saveGmpNewReceivingBaseDetails",
      },
      "renewgmpreceivingwizard button[name=save_btn]": {
        //renewal
        click: "saveGmpRenewalReceivingBaseDetails",
      },
      "cancelgmpreceivingwizard button[name=save_btn]": {
        //withdrawal
        click: "saveGmpRenewalReceivingBaseDetails",
      },
      "altgmpreceivingwizard button[name=save_btn]": {
        //alteration
        click: "saveGmpRenewalReceivingBaseDetails",
      },
      ...
      "mansiteappmoredetailswizard button[name=save_btn]": {
        //late updates...Inspection and Com with Applicants
        click: "updateGmpApplicationDetails",
      },
      "mansiteappmoredetailsaltwizard button[name=save_btn]": {
        //late updates...Inspection and Com with Applicants
        click: "updateGmpApplicationDetails",
      },
  ...
  saveGmpproductlinedetails: function (btn) {
    ...
    if (grid.up("window")) {
      ...
      (application_code = win
        ...
        .getValue()),
        (manufacturing_site_id = win
          .down("hiddenfield[name=manufacturing_site_id]")
          .getValue());
    } else {
      manufacturing_site_id = activeTab
        .down("hiddenfield[name=manufacturing_site_id]")
        .getValue();
    ...
    for (var i = 0; i < store.data.items.length; i++) {
      var record = store.data.items[i],
        ...
        prodline_inspectionstatus_id = record.get(
          "prodline_inspectionstatus_id"
        ),
        id = record.get("id");
  ...
  previewGmpOnlineApplication: function (view, record) {
    ...
    onlinePanel
      .down("combo[name=assessment_type_id]")
      .setValue(assessment_type_id);
    onlinePanel
    ...
    personnelDetailsGrid
      ...
      .setValue(isReadOnly);
    siteBlockDetailsGrid
      .down("hiddenfield[name=isReadOnly]")
      .setValue(isReadOnly);
    siteOtherDetailsGrid
      .down("hiddenfield[name=isReadOnly]")
      .setValue(isReadOnly);
  ...
  refreshGmpApplicationsMainGrids: function (me) {
    var store = me.store,
      ...
      workflow_stage_id = grid.down("combo[name=workflow_stage_id]")
        ...
        : null,
      gmp_type_id = grid.down("combo[name=gmp_type_id]")
        ? grid.down("combo[name=gmp_type_id]").getValue()
        : null;
    store.getProxy().extraParams = {
      module_id: module_id,
      section_id: section_id,
  ...
  onNewGmpApplication: function (sub_module_id, wrapper_xtype, gmp_type_id) {
    ...
    workflowContainer
      ...
      .setValue(gmp_type_id);
    workflowContainer
      .down("displayfield[name=gmp_type_txt]")
      .setValue(gmp_type_txt);
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            if (results) {
              ...
              pnl
                .down("combo[name=device_type_id]")
                .setValue(results.device_type_id);
              pnl
                .down("combo[name=assessment_type_id]")
                .setValue(results.assessment_type_id);
              ...
              productLineDetailsStr.load({
                params: { site_id: results.manufacturing_site_id },
              });
            }
            if (ltrDetails) {
  ...
  prepareNewGmpReceiving: function () {
    ...
    var me = this,
      ...
      gmpproducts_store = activeTab
        .down("gmpproductslinkagedetailsgrid")
        .getStore(),
      ...
      Ext.Ajax.request({
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            //product_details.setValue(results.product_details); // job to reinstate produdct derails set just due for demo 07/02/24
  ...
  prepareNewGmpDeskReviewScheduling: function () {
    ...
    var me = this,
      ...
      inspection_id = inspectionDetailsFrm
  ...
  prepareNewProvisionalGmpInspection: function () {
    ...
    var me = this,
      mainTabPanel = me.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab(),
      productLine_store = activeTab.down(
  ...
  prepareNewGmpInspection: function () {
    ...
    var me = this,
      ...
      inspectionscaparequestsgrid = activeTab.down(
            ...
            if (results) {
              ...
              if (activeTab.down("inspectiondetailsupdatefrm")) {
                if (inspection_details) {
                  var inspection_details = Ext.create(
                    "Ext.data.Model",
                    inspection_details
                  );

                  var inspectiondetailsupdatefrm = activeTab.down(
                    "inspectiondetailsupdatefrm"
                  );
  ...
  prepareGmpTCMeetingSchedulingGeneric: function (
    activeTab,
    applicationsGrid,
    isReadOnly
  ) {
  ...
  prepareNewGmpTCRecommendation1: function () {
    ...
    var me = this,
      ...
      activeTab = mainTabPanel.getActiveTab(),
      productLine_store = activeTab.down(
        "productlinedetailstcrecommgrid"
      ).store,
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
  ...
  prepareNewGmpSingleApproval: function () {
    ...
    var me = this,
      ...
      activeTab = mainTabPanel.getActiveTab(),
      productLine_store = activeTab.down(
        "productlinedetailsdgrecommgrid"
      ).store,
      application_id = activeTab
        .down("hiddenfield[name=active_application_id]")
        .getValue(),
  ...
  prepareRenewGmpReceiving: function () {
    ...
    activeTab
      .down("mansiteotherdetailsgrid")
      .down("hiddenfield[name=isReadOnly]")
      .setValue(1);
    activeTab
      .down("mansitepersonneldetailsgrid")
      .down("hiddenfield[name=isReadOnly]")
      .setValue(1);
    activeTab
      .down("mansiteblockdetailsgrid")
      .down("hiddenfield[name=isReadOnly]")
      .setValue(1);
    ...
    productlinedetailsgrid.columns[
      productlinedetailsgrid.columns.length - 1
    ].setHidden(true);
  ...
  prepareGmpComparePreview: function (pnl) {
    var me = this,
      ...
      portalProductsGrid = portalWizard.down(
        "gmpproductslinkagedetailsonlinegrid"
      ),
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            if (portalResults) {
              ...
              portalPnl
                .down("combo[name=gmp_type_id]")
                .setValue(portalResults.gmp_type_id);
              portalPnl
                .down("combo[name=device_type_id]")
                .setValue(portalResults.device_type_id);
              portalPnl
                .down("combo[name=assessment_type_id]")
                .setValue(portalResults.assessment_type_id);
            }
            if (portalContactPersonDetails) {
              var model1 = Ext.create(
                "Ext.data.Model",
                portalContactPersonDetails
              );
            ...
            if (misResults) {
              ...
              misPnl
                .down("combo[name=gmp_type_id]")
                .setValue(misResults.gmp_type_id);
              misPnl
                .down("combo[name=device_type_id]")
                .setValue(misResults.device_type_id);
              misPnl
                .down("combo[name=assessment_type_id]")
                .setValue(misResults.assessment_type_id);
            }
            if (misContactPersonDetails) {
              var model4 = Ext.create(
                "Ext.data.Model",
                misContactPersonDetails
              );
  ...
  beforeManSiteTabChange: function (tabPnl, newTab) {
    ...
    if (sub_module_id == 5) {
      ...
      if (tabPnl.items.indexOf(newTab) > 1) {
        if (!application_id) {
          toastr.warning(
            "Save Application details first!!",
            "Warning Response"
          );
          return false;
        }
  ...
  saveGmpNewReceivingBaseDetails: function (btn) {
    var me = this,
      ...
      applicant_contact_person = contactPersonForm
        .down("combo[name=applicant_contact_person]")
        .getValue(),
      contact_person_id = contactPersonForm
        .down("hiddenfield[name=id]")
        .getValue(),
      contact_person_startdate = contactPersonForm
        .down("datefield[name=start_date]")
        .getValue(),
      contact_person_enddate = contactPersonForm
      ...
      applicant_as_ltr = ltrForm
        .down("combo[name=applicant_as_ltr]")
        .getValue(),
    ...
    if (manSiteDetailsFrm.isValid()) {
      if (!applicant_as_ltr) {
        toastr.warning(
          "Please select Local Technical Representative!!",
          "Warning Response"
        );
        return false;
          ...
          if (success == true || success === true) {
            if (toaster == 1 || toaster === 1) {
              ...
              activeTab
                ...
                .setValue(site_id);
              activeTab
                .down("hiddenfield[name=registered_manufacturing_site_id]")
                .setValue(reg_site_id);
              manSiteDetailsForm
                .down("hiddenfield[name=manufacturing_site_id]")
                .setValue(site_id);
              manSiteDetailsForm
                .down("button[action=search_site]")
                .setDisabled(true);
              manSiteDetailsForm
                .down("button[name=search_site]")
                .setDisabled(true);
  ...
  saveGmpRenewalReceivingBaseDetails: function (btn) {
    var me = this,
      ...
      applicant_as_ltr = ltrForm
        .down("combo[name=applicant_as_ltr]")
        .getValue(),
      productLineDetailsStore = activeTab
        .down("productlinedetailsgrid")
        .getStore(),
      manSiteDetailsForm = activeTab.down("mansitedetailsfrm"),
      manSiteDetailsFrm = manSiteDetailsForm.getForm(),
  ...
  updateGmpApplicationDetails: function (btn) {
    var me = this,
      ...
      workflow_stage_id = wizardPnl
        .down("hiddenfield[name=workflow_stage_id]")
        .getValue(),
      application_id = wizardPnl
        .down("hiddenfield[name=application_id]")
        .getValue(),
  ...
  onsearchinspectionschedulesgridDblClick: function (
    view,
    record,
    item,
    index,
    ...
    var me = this,
      ...
      mainTabPanel = me.getMainTabPanel(),
      activeTab = mainTabPanel.getActiveTab(),
      gmpinspectionscheduleteamfrm = activeTab.down(
        "gmpinspectionscheduleteamfrm"
      ),
      mask = new Ext.LoadMask({
        msg: "Please wait...",
        target: win,
  ...
  showAddSitePersonnelDetails: function (btn) {
    var me = this,
      ...
      activeTab = mainTabPanel.getActiveTab(),
      site_id = activeTab
        .down("mansitedetailsfrm")
        .down("hiddenfield[name=manufacturing_site_id]")
        .getValue(),
      trader_id = activeTab
        .down("applicantdetailsfrm")
        .down("hiddenfield[name=applicant_id]")
        .getValue(),
      childXtype = btn.childXtype,
      title = btn.winTitle,
  ...
  showAddGmpProductLineDetails: function (btn) {
    var me = this,
      ...
      activeTab = mainTabPanel.getActiveTab();
    section_id = activeTab.down("hiddenfield[name=section_id]").getValue();
    if (activeTab.down("hiddenfield[name=manufacturing_site_id]")) {
      site_id = activeTab
        .down("hiddenfield[name=manufacturing_site_id]")
        .getValue();
      application_code = activeTab
  ...
  validateNewGmpReceivingSubmission: function (btn) {
    ...
    if (!manufacturingSiteFrm.isValid()) {
      toastr.warning(
        "Please Enter All the required Premise Details!!",
        "Warning Response"
      );
      return false;
    }
  ...
  showInspectionApplicationSubmissionWin: function (btn) {
    ...
    var mainTabPanel = this.getMainTabPanel(),
      ...
      application_code = activeTab
        .down("hiddenfield[name=active_application_code]")
        .getValue(),
      hasQueries = checkApplicationRaisedQueries(
        application_code,
        module_id,
        2
      ),
    ...
    if (inspection_frm.isValid()) {
      gmpinspection_recommendation_id = inspection_frm
        .down("combo[name=gmpinspection_recommendation_id]")
        .getValue();
    } else {
      Ext.getBody().unmask();
      toastr.warning(
        "Please fill and save in the GMP Inspection Details before submission!!",
        "Validation Check"
      );
      return false;
    }
    ...
    if (hasQueries == 2) {
      toastr.warning(
        "Enter the query Items for the open query to proceed with the query submission!!",
        "Warning Response"
      );
      Ext.getBody().unmask();
      return false;
  ...
  validateRenewGmpReceivingSubmission: function (btn) {
    ...
    if (!siteFrm.isValid()) {
      toastr.warning(
        "Please Enter All the required manufacturing site details!!",
        "Warning Response"
      );
      return false;
    }
    ...
    if (sub_module_id == 6 || sub_module_id === 6) {
      ...
      if (screeningGrid.getStore().getModifiedRecords().length > 0) {
        Ext.getBody().unmask();
        toastr.warning(
          "There are unsaved screening data!!",
          "Warning Response"
        );
        return false;
      }
  ...
  showGmpApplicationMoreDetailsGeneric: function (
    ...
    var me = this,
      wizardPnl = Ext.create("Ext.tab.Panel", {
        layout: "fit",
        items: [{ xtype: childXtype, title: "GMP Application Details " }],
      }),
    ...
    Ext.Ajax.request({
      ...
      success: function (response) {
        ...
        if (success == true || success === true) {
          ...
          funcShowCustomizableWindow(
            "Preview GMP Inspection Application " + ref_no,
            "85%",
            wizardPnl,
            "customizablewindow"
          );
  ...
  onManSiteSelectionListDblClick: function (
    view,
    record,
    item,
    index,
  ...
  onManufacturingSiteSelectionListDblClick: function (
    view,
    record,
    item,
    index,
    ...
    activeTab
      .down("combo[name=gmp_type_id]")
      .setValue(record.get("gmp_type_id"));
    activeTab
      .down("combo[name=device_type_id]")
      .setValue(record.get("device_type_id"));
    activeTab
      .down("combo[name=assessment_type_id]")
      .setValue(record.get("assessment_type_id"));
    if (sub_module_id == 6 || sub_module_id === 6) {
      //Renewal
  ...
  showAddInspectionOtherDetails: function (btn) {
    ...
    if (!inspection_id) {
      toastr.warning(
        "Please save inspection team details first!!",
        "Warning Response"
      );
      return;
    }
  ...
  showPreviousUploadedDocs: function (btn) {
    var me = this,
      ...
      static_stage = getGmpModuleStaticStage(
        sub_module_id,
        section_id,
        target_stage
      );
