Ext.define("Admin.controller.EnforcementCtr", {
  ...
  config: {
    ...
    control: {
      ...
      "newinvestigationreceivingwizard button[name=save_btn]": {
        //renewal
  ...
  listen: {
    controller: {
      "*": {
        ...
        funcActiveOtherEnforcementInformationTab:
          "funcActiveOtherEnforcementInformationTab",
        loadEnforcementReportingWizardFromRecord:
          "EnforcementReportingApplication",
        loadMonitoringComplianceWizardFromRecord:
          "MonitoringComplianceApplication",
        getEnforcementApplicationApprovalDetails:
          "getApplicationApprovalDetails",
        ...
        showEnforcementApplicationMoreDetails:
          "showEnforcementApplicationMoreDetails",
      },
    },
  },
  ...
  refreshEnforcementMainGrid: function (me) {
    ...
    (module_id = activeTab.down("hiddenfield[name=module_id]").getValue()),
      (section_id = activeTab.down("hiddenfield[name=section_id]")
        ? grid.down("combo[name=section_id]").getValue()
        : null),
  ...
  prepareNewReportReceiving: function (me) {
    ...
    var me = this,
      ...
      application_status_id = activeTab
        ...
        .getValue(),
      report_type_id = activeTab
        .down("hiddenfield[name=report_type_id]")
        .getValue(),
      ...
      enforcement_id = activeTab
        .down("hiddenfield[name=enforcement_id]")
        .getValue(),
  ...
  onRegisteredProductGridDoubleClick: function (
    ...
    if (activeTab.down("#suspectinforFrm")) {
      form
        .down("textfield[name=certificate_no]")
        .setValue(record.get("certificate_no"));
      form
        .down("textfield[name=brand_name]")
        .setValue(record.get("brand_name"));
      form
        .down("textfield[name=common_name]")
        .setValue(record.get("common_name"));
      form
        .down("textfield[name=section_id]")
        .setValue(record.get("section_id"));
      form
        .down("textfield[name=prodclass_category_id]")
      ...
      if (form.down("textfield[name=product_description]")) {
        form
          .down("textfield[name=product_description]")
          .setValue(record.get("product_description"));
      }
      if (form.down("datefield[name=expiry_date]")) {
        form
          .down("datefield[name=expiry_date]")
          .setValue(record.get("expiry_date"));
      }
      if (form.down("textfield[name=dosage_form]")) {
        form
          .down("textfield[name=dosage_form]")
          .setValue(record.get("dosage_form"));
      }
      if (form.down("textfield[name=manufacturer]")) {
        form
          .down("textfield[name=manufacturer]")
          .setValue(record.get("manufacturer"));
      }
      //product_description
      else {
      }
  ...
  onRegisteredFacilitygridDblClick: function (view, record) {
    ...
    if (activeTab.down("licenseInformationFrm")) {
      form
        .down("hiddenfield[name=reg_premise_id]")
        .setValue(record.get("reg_premise_id"));
      form
        .down("hiddenfield[name=premise_id]")
        .setValue(record.get("premise_id"));
      form
        .down("textfield[name=permit_no]")
        .setValue(record.get("certificate_no"));
      form.down("textfield[name=premise_name]").setValue(record.get("name"));
      form
        .down("combo[name=premise_type]")
        .setValue(record.get("premise_type_id"));
      ...
      form
        ...
        .setValue(record.get("physical_address"));
      form
        .down("textfield[name=postal_address]")
        .setValue(record.get("postal_address"));
    } else {
      form
        .down("textfield[name=permit_no]")
        .setValue(record.get("certificate_no"));
      ...
      form
        ...
        .setValue(record.get("physical_address"));
      form
        .down("numberfield[name=telephone]")
        .setValue(record.get("telephone"));
  ...
  onPremisePersonnelDblClick: function (view, record, item, index, e, eOpts) {
    ...
    console.log(grid);
    form
      .down("textfield[name=responsible_personnel]")
      ...
      Ext.Ajax.request({
        ...
        success: function (response) {
          ...
          if (success == true || success === true) {
            ...
            activeTab
              .down("hiddenfield[name=enforcement_id]")
              .setValue(results.enforcement_id);
            activeTab
              .down("hiddenfield[name=joint_investigation_id]")
              .setValue(results.joint_investigation_id);
          } else {
            toastr.error(message, "Failure Response");
          }
        },
  ...
  showEnforcementApplicationSubmissionWin: function (btn) {
    ...
    if (valid == true) {
      ...
      Ext.getBody().unmask();
      toastr.warning(
        "Please Enter All the required Enforcment Details!!",
        "Warning Response"
      );
      return;
    }
  ...
  showNewInvestigationReceivingApplicationSubmissionWin: function (btn) {
    ...
    if (valid) {
      ...
      Ext.getBody().unmask();
      toastr.warning(
        "Please Enter All the required Enforcement Details!!",
        "Warning Response"
      );
      return;
    }
  ...
  onApplicantSelectionListDblClick: function (
    ...
    if (grid.applicantType === "nonlocal") {
      if (activeTab.down("complainantfrm")) {
        ...
        jointOperationsWorkPlanFrm = activeTab.down(
          "jointOperationsWorkPlanFrm"
        );
  ...
  funcActiveOtherEnforcementInformationTab: function (tab) {
    ...
    if (
      activeTab.down("hiddenfield[name=enforcement_id]") &&
      enforcement_id == ""
    ) {
      enforcement_id = activeTab
        .down("hiddenfield[name=enforcement_id]")
  ...
  prepareReportingApplicationBaseDetails: function (tab, record) {
    ...
    if (tab.down("hiddenfield[name=enforcement_id]")) {
      tab
        .down("hiddenfield[name=enforcement_id]")
        .setValue(record.get("enforcement_id"));
    }
  ...
  addInvestigationApplicationWorkflowParams: function (me) {
    ...
    if (workplanScheduling && workplanScheduling == 1) {
      workplan_id = activeTab
        .down("workplanfrm")
        .down("hiddenfield[name=workplan_id]")
        .getValue();
  ...
  saveInvestigationReceivingDetails: function (btn) {
    ...
    var complainantfrm = activeTab.down("complainantfrm"),
      applicant_id = complainantfrm
        .down("hiddenfield[name=applicant_id]")
        .getValue(),
      report_type_id = complainantfrm
        .down("combo[name=report_type_id]")
        .getValue(),
      suspectinforfrm = activeTab.down("suspectinforFrm"),
      ...
      entity_type_id = suspectinforfrm
        .down("combo[name=entity_type_id]")
        .getValue(),
      brand_name = suspectinforfrm
        .down("textfield[name=brand_name]")
        .getValue(),
      common_name = suspectinforfrm
        .down("textfield[name=common_name]")
        .getValue(),
      product_section_id = suspectinforfrm
        .down("combo[name=section_id]")
        .getValue(),
      prodclass_category_id = suspectinforfrm
        .down("combo[name=prodclass_category_id]")
        .getValue(),
      premise_name = suspectinforfrm
        .down("textfield[name=premise_name]")
        .getValue(),
      premise_type = suspectinforfrm
        .down("combo[name=premise_type]")
        .getValue(),
      ...
      suspect_physical_address = suspectinforfrm
        .down("textfield[name=suspect_physical_address]")
        .getValue(),
      suspect_postal_address = suspectinforfrm
        .down("textfield[name=suspect_postal_address]")
        .getValue(),
      suspect_telephone = suspectinforfrm
        .down("numberfield[name=suspect_telephone]")
        .getValue(),
      other_details = suspectinforfrm
        .down("htmleditor[name=other_details]")
        .getValue();
    batch_number = suspectinforfrm
      .down("textfield[name=batch_number]")
      .getValue();
    expiry_date = suspectinforfrm
      .down("datefield[name=expiry_date]")
      .getValue();
    ...
    if (!suspectinforfrm.isValid()) {
      toastr.warning(
        "Please fill the Suspect Information form!!",
        "Warning Response"
      );
      return false;
    }
      ...
      complainantfrm.submit({
        ...
        success: function (frm, action) {
          ...
          if (success == true || success === true) {
            ...
            activeTab
              .down("hiddenfield[name=active_application_code]")
              .setValue(active_application_code);
            activeTab
              .down("hiddenfield[name=enforcement_id]")
              .setValue(enforcement_id);
            activeTab
  ...
  prepareEnforcementManagerMeeting: function () {
    ...
    console.log(activeTab);
    this.prepareEnforcementMeetingDetailsGeneric(
      activeTab,
      applicationsGrid,
      0
    );
  },
  prepareEnforcementMeetingDetailsGeneric: function (
    activeTab,
    applicationsGrid,
    isReadOnly
  ) {
  ...
  prepareDebriefingMeetingDetails: function (
    activeTab,
    applicationsGrid,
    isReadOnly
  ) {
      ...
      frm.submit({
        ...
        success: function (form, action) {
          ...
          if (success == true || success === true) {
            ...
            store.removeAll();
            store.load({
              params: { active_application_code: active_application_code },
            });
            win.close();
          } else {
            toastr.error(message, "Failure Response");
  ...
  prepareMonitoringReceiving: function (me) {
    ...
    var me = this,
      ...
      application_id = activeTab
        ...
        .getValue(),
      licenseInformationFrm = activeTab.down("licenseInformationFrm"),
      reg_premise_id = licenseInformationFrm
        .down("hiddenfield[name=reg_premise_id]")
        .getValue(),
      premise_id = licenseInformationFrm
        .down("hiddenfield[name=premise_id]")
        .getValue(),
      enforcement_id = activeTab
        .down("hiddenfield[name=enforcement_id]")
  ...
  saveMonitoringReceivingDetails: function (btn) {
    var me = this,
      ...
      active_application_code = activeTab
        ...
        .getValue(),
      licenseInformationFrm = activeTab.down("licenseInformationFrm"),
      enforcement_id = licenseInformationFrm
        .down("hiddenfield[name=enforcement_id]")
        .getValue(),
      reg_premise_id = licenseInformationFrm
        .down("hiddenfield[name=reg_premise_id]")
      ...
      premise_id = licenseInformationFrm
        .down("hiddenfield[name=premise_id]")
        .getValue(),
      facility_reg = licenseInformationFrm
        .down("combo[name=is_facility_registered]")
        .getValue();

    monitoringpremisepersonnelgrid = activeTab.down(
      "monitoringpremisepersonnelgrid"
    );
  ...
  showAnnualWorkPlansSelectionList: function (btn) {
    ...
    if (activeTab.down("applicationpmsplandetailsfrm")) {
      ...
      var planProgramForm = Ext.ComponentQuery.query(
          "#applicationpmsplandetailsfrmRefID"
        )[0],
        program_id = planProgramForm
          .down("hiddenfield[name=program_id]")
          .getValue();
      //console.log('reached the second loop for pms');
    }

    var section_id = activeTab.down("hiddenfield[name=section_id]").getValue(),
      dosageFormCol = childObject
        .getColumnManager()
        .getHeaderByDataIndex("dosage_form"),
      productFormCol = childObject
        .getColumnManager()
        .getHeaderByDataIndex("product_form"),
      deviceTypeCol = childObject
        .getColumnManager()
        .getHeaderByDataIndex("device_type");
    if (
      section_id == 1 ||
      section_id == 3 ||
      section_id === 1 ||
        ...
        success: function (form, action) {
          ...
          if (success == true || success === true) {
            ...
            if (frm == "monitoringpremisepersonnelfrm") {
              (dispensingComplianceGrid = activeTab.down(
                "dispensingComplianceGrid"
              )),
  ...
  savePrescribingComplianceInformation: function (btn) {
    ...
    this.commitPrescribingComplianceDetails(
      btn,
      application_id,
      application_code,
      prescribingGrid
  ...
  commitPrescribingComplianceDetails: function (
    btn,
    application_id,
    application_code,
    prescribingGrid
    ...
    (store = prescribingGrid.getStore()), (params = []);
  ...
  saveDispensingComplianceInformation: function (btn) {
    ...
    this.commitDispensingComplianceDetails(
      btn,
      application_id,
      application_code,
      dispensingGrid
  ...
  commitDispensingComplianceDetails: function (
    btn,
    application_id,
    application_code,
    dispensingGrid
    ...
    // var checklist_type = prescribingGrid.down('combo[name=applicable_checklist]').getValue(),
    (store = dispensingGrid.getStore()), (params = []);
    for (var i = 0; i < store.data.items.length; i++) {
      var record = store.data.items[i],
    ...
    if (frm.isValid()) {
      ...
      frm.submit({
        ...
        success: function (fm, action) {
          ...
          if (success == true || success === true) {
            form
              .down("hiddenfield[name=seizureplan_id]")
              .setValue(seizureplan_id);
            if (toaster == 1 || toaster === 1) {
              toastr.success(message, "Success Response");
            }
          } else {
  ...
  prepareSeizureWorkPlanReceiving: function (me) {
    ...
    var me = this,
      ...
      seizureplan_id = SeizureWorkPlamfrm.down(
        "hiddenfield[name=seizureplan_id]"
      ),
      workplanapplicationgrid = activeTab.down("workplanapplicationgrid"),
      process_id = activeTab.down("hiddenfield[name=process_id]").getValue(),
      section_id = activeTab.down("hiddenfield[name=section_id]").getValue(),
  ...
  showCaseRegister: function (sub_module_id, wrapper_xtype) {
    ...
    dashboardWrapper.removeAll();
    var enforcementRegisteredCasesGrid = Ext.widget(
      "enforcementRegisteredCasesGrid"
    );
  ...
  prepareCaseOffences: function (me) {
    //me - the form
  ...
  prepareOffencesCharges: function (me) {
    //me - the form
    pnl = me.up("panel");
    console.log(pnl);
    grid = pnl.down("grid");
  ...
  showApplicationComplianceDetails: function (btn) {
    ...
    enforcement_view = "enforcementDetailsPnl";
    if (module_id == 8) {
      this.showApplicationComplianceGenericDetails(
        application_code,
        "complianceAssesmentDataPnl",
        module_id,
        sub_module_id,
        section_id,
        isReadOnly
  ...
  showApplicationComplianceGenericDetails: function (
    application_code,
    details_panel,
    module_id,
    sub_module_id,
    ...
    details_panel.down("hiddenfield[name=section_id]").setValue(section_id);
    details_panel
      .down("button[name=add_controlled_personnel]")
      .setVisible(false);
  ...
  showMonitoringEnforcementAction: function (sub_module_id, wrapper_xtype) {
    ...
    var me = this,
      ...
      dashboardWrapper = activeTab.down(wrapper_xtype);
    dashboardWrapper.removeAll();
    var monitoringenforcementActionGrid = Ext.widget(
      "monitoringenforcementActionGrid"
    );
  ...
  saveJointOperationReceivingDetails: function (btn) {
    var me = this,
      ...
      active_application_code = activeTab
        ...
        .getValue(),
      //enforcement_id = activeTab.down('hiddenfield[name=enforcement_id]').getValue(),
      joint_operation_id = activeTab
        .down("hiddenfield[name=joint_operation_id]")
        .getValue(),
      //
      //joint_operation_id
      // suspectinforfrm =activeTab.down('suspectinforFrm');
  ...
  prepareJointFacilityOffences: function (me) {
    //me - the form
    (active_application_code = me
      .down("hiddenfield[name=active_application_code]")
      .getValue()),
      console.log(active_application_code);
