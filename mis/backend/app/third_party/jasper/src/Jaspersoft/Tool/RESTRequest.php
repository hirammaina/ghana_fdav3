...
*/
            ...
            if(!empty($responseBody)) {
                ...
                if (!empty($errorData->parameters)) {
                    $exception->parameters = $errorData->parameters;
								...
								$return_error = array('success'=>false, 'message'=>'Error occurred Status Code'.$statusCode);
                ...
                $exception->expectedStatusCodes = $expectedCodes;
                $exception->statusCode = $statusCode;
								$return_error = array('success'=>false, 'message'=>'Error occurred Status Code'.$statusCode.' Error Code '. $exception->statusCode);
                                   ...
                                   $contentType = 'application/json', $acceptType = 'application/json', $headers = array())
    {
        ...
        if (!in_array($statusCode, $expectedCodes)) {
          ...
          return  $this->handleError($statusCode, $expectedCodes, $responseBody);
        }
