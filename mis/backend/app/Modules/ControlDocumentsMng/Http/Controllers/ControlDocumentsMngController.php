...
namespace App\Modules\ControlDocumentsMng\Http\Controllers;
          ...
          try {
            ...
            if (isset($filter)) {
               ...
               $qry = DB::table('tra_doccontrolreview_management as t1')
                ...
                ->select(DB::raw("t7.date_received, CONCAT_WS(' ',decryptVal(t8.first_name),decryptVal(t8.last_name)) as requested_byname,CONCAT_WS(' ',decryptVal(t9.first_name),decryptVal(t9.last_name)) as approved_byname,  t1.id as active_application_id, t1.application_code, t4.module_id, t4.sub_module_id, t4.section_id, t2.name as document_type,t11.name as directorate_unit, t10.name as directorate_name,
