...
namespace App\Modules\Importexportpermits\Traits;
...
trait ImportexportpermitsTraits
{
            ...
            DB::transaction(function () use ($qry, $application_id, $application_code, $table_name, $request, $application_details, &$res) {
                ...
                $params = array(
                    ...
                    'permit_signatory' => $permit_signatory
                        ...
                        $params['certificate_issue_date'] = $approval_date;
						$approvalrecord = DB::table('tra_managerpermits_review')->where('application_code',$application_code)->first();
						if($approvalrecord){
                        ...
                        if (validateIsNumeric($id)) {
                          ...
                          //  $prev_data_results[0]['record_id'] = $id;
                            ...
                            if ($decision_id == 1) {
                                $product_status_id = 6;
                              if($sub_module_id == 12 || $sub_module_id == 83 || $sub_module_id == 60){
									 $portal_status_id = 39;
								}
								else{
									 $portal_status_id = 33;
    ...
    public function saveMultiImportExportOnlineApplicationDetails(Request $request)
    {
        ...
        foreach( $selected_appCodes as  $application_code){
            ...
            $res= $this->funcImpApplicationSubmission('',$responsible_user,$urgency,$comment,$user_id,$status_type_id,$application_code,$sub_module_id,$next_stage,$applications_table,$request);
    ...
    public function saveImportExportOnlineApplicationDetails(Request $request)
    {
        ...
        $res= $this->funcImpApplicationSubmission($application_id,$responsible_user,$urgency,$comment,$user_id,$status_type_id,$application_code,$sub_module_id,$next_stage,$applications_table,$request);

        return $res;
    }
    function funcImpApplicationSubmission($application_id,$responsible_user,$urgency,$comment,$user_id,$status_type_id,$application_code,$sub_module_id,$next_stage,$applications_table,$request){
        ...
        try {
            ...
            $app_previousdata = DB::table($applications_table)
					...
					if(validateIsNumeric($request->premisesvalidation_assignment_id)){
						 $submission_params = array(
								'application_id' => $application_insert['record_id'],
								'process_id' => $process_details->id,
								'application_code' => $application_code,
								'tracking_no' => $tracking_no,
								'usr_from' => $user_id,
								'usr_to' => $request->premisesvalidation_respuser_id,
								'previous_stage' => $workflow_details->id,
								'current_stage' => $request->premisesvalidation_assignment_id,
								'module_id' => $results->module_id,
								'sub_module_id' => $results->sub_module_id,
								'section_id' => $results->section_id,
								'application_status_id' => $app_status_id,
