...
namespace App\Modules\Revenuemanagement\Http\Controllers;
...
//invoice_no
    ...
    public function getApplicationInvoiceDetails(Request $request)
    {
        ...
        try {
            ...
            $data = array('feetype_id'=>$feetype_id, 
        ...
        try {
			...
			if(validateIsNumeric($application_code)){
				$invoicing_data = DB::table('tra_application_invoices as t1')
                    ...
                    ->select(DB::raw("SUM(t2.element_amount) as total_element_amount,t1.application_code, SUM(t2.element_amount*t2.paying_exchange_rate) as equivalent_paid, t3.name as currency, t1.date_of_invoicing,t2.paying_exchange_rate as exchange_rate, t1.invoice_no, t1.id as invoice_id, t4.name as invoice_type, t2.paying_currency_id"))
