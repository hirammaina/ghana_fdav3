...
use App\Modules\Parameters\Entities\Finance\elementscost;
    ...
    public function getelementcost(request $request){
        ...
        try {
            $qry = DB::table('tra_element_costs as t1')
                ...
                ->select('t1.*', 't1.id as element_costs_id','t11.name as section_name','t4.name as currency_name', 'a7.section_id', 't4.id as currency_id', 't2.name as element', 't13.product_code as irembo_productcode','t13.product_name as irembo_productname','t13.product_amount',
