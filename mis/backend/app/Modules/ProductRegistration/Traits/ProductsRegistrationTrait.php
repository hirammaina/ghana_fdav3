...
//zone_id
                    ...
                    updatePortalApplicationStatusWithCode($application_code, 'wb_product_applications',$portal_status_id);
						if($decision_id == 1  || $decision_id == 2){
							...
							if($decision_id == 1){
							   $res_cert = $this->funcGeneraPrroductsertificate($request,$application_code,$sub_module_id);
	...
	public function funcGeneraPrroductsertificate($request,$application_code,$sub_module_id){
				
		$attachement_name = 'Human Medicines Products Certificate';
