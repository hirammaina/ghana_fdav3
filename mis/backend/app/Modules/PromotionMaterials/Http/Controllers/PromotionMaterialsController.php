...
namespace App\Modules\PromotionMaterials\Http\Controllers;
    ...
    try {
		...
		$local_agent_id = $results->local_agent_id;
		 ...
		 $query = DB::table('tra_premises as t1')
                ...
                't1.postal_address as app_postal_address', 't1.telephone as app_telephone', 't1.email as app_email', 't1.website as app_website')
