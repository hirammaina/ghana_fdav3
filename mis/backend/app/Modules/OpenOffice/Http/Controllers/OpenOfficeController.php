...
namespace App\Modules\OpenOffice\Http\Controllers;
  ...
  public function getEnquiries(request $request){
   ...
   try{
    $qry=DB::table('tra_submissions as t1')
        ...
        ->select(DB::raw("t1.reference_no,t1.tracking_no,t1.date_released,t1.date_received,t1.date_submitted,'t1.isDone','t1.isRead',CONCAT(decryptVal(t2.first_name),decryptVal(t2.last_name)) as from_user,CONCAT(decryptVal(t3.first_name),decryptVal(t3.last_name)) as to_user,CONCAT(decryptVal(t4.first_name),decryptVal(t4.last_name)) as submitted_by,t5.name as applicant,t6.name as previous_process,t7.name as current_process,t8.name as Process,TOTAL_WEEKDAYS(t1.date_received,t1.date_released) as total_days"));
