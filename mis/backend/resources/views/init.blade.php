...
<script type="text/javascript" src="{{asset('resources/statics/vendor/jquery-3.4.1/jquery.min.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/statics/vendor/bootstrap-4.4.1/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/statics/vendor/bootstrap-toggle/js/bootstrap-toggle.min.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/statics/oauth/cloudpki.api.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/statics/oauth/cloudpki.ui.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/statics/js/ui-events.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/statics/assets/form-to-json.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/statics/assets/script.js')}}"></script>
