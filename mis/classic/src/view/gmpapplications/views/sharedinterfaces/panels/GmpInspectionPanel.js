 ...
 */
Ext.define(
  "Admin.view.gmpapplications.views.sharedinterfaces.panels.GmpInspectionPanel",
  {
    ...
    items: [
                          ...
                          menu: {
                            ...
                            items: [
                              ...
                              },
                              {
                                ...
                                storeID: "gmpinspectorsstr",
                                action_url:
                                  "gmpapplications/deleteGmpApplicationRecord",
      ...
      },
      {
        ...
        items: [
          //   {
          //     xtype: "transitionsbtn", //job suspended due to space
          //   },
