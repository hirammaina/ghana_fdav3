 ...
 */
Ext.define(
  "Admin.view.workflowmanagement.views.forms.WorkflowSubmissionManagerQueryFrm",
  {
    extend:
            ...
            listeners: {
              ...
              change: function (cmb, newVal) {
                var thisStore = cmb.getStore(),
                  ...
                  form = cmb.up("form"),
                  responsible_users = form.down("combo[name=responsible_user]"),
                  current_stage_id = form
                    .down("hiddenfield[name=curr_stage_id]")
                    .getValue(),
                  store = responsible_users.store,
                  inspection_id = form
                    .down("hiddenfield[name=inspection_id]")
                    .getValue(),
                  module_id = form
