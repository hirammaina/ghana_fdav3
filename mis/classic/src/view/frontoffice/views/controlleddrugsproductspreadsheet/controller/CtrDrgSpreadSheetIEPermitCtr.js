var IEP_sectionid="";
var IEP_sub_module="";
Ext.define('Admin.view.openOffice.controlleddrugsproductspreadsheet.controller.CtrDrgSpreadSheetIEPermitCtr', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ctrdrgspreadsheetiepermitctr',
...
store.load();
          ...
          loadApplicationColumns: function(sender,record) {
              ...
              var filter = {'t1.regulated_producttype_id':IEP_sectionid};
         ...
         func_exportiepermitspreadsheet: function (btn) {
                 ...
                 // console.log(grid);
                  //filters
                      ...
                      var Originalfilter = {'t1.regulated_producttype_id':IEP_sectionid,'t1.sub_module_id':IEP_sub_module};
    ...
    editpreviewPermitinformation: function (item) {
      this.fireEvent('editSpreadhsheetpreviewPermitinformation', item);
  },
