 ...
 extend: 'Ext.grid.Panel',  
   ...
   plugins: [{
        ...
        },
    {
        ...
        xtype: 'gridcolumn',
        dataIndex: 'productphysical_description',
        name: 'productphysical_description',
        text: 'Product Physical Description',
        tdCls:'wrap-text',
        width: 200,
        filter: {
                xtype: 'textfield',
        ...
        text: 'Product Manufacturing Date',
        tdCls:'wrap-text',
        width: 200,
        filter: {
                xtype: 'datefield',
