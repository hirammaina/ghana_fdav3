Ext.define('Admin.view.frontoffice.product.container.CosmeticsSpreadsheet', {
    extend: 'Ext.form.Panel',
    xtype: 'cosmeticsspreadsheet',
    layout:'border',
                    ...
                    listeners:
                     {
                        ...
                        beforequery: function() {
                          var store=this.getStore();
                            var all={name: 'All Product Types(new,renewal ....)',id:0};
                              store.insert(0, all);
                          ...
                          config: {
                              ...
                              proxy: {
                                  ...
                                  extraParams: {
                                      ...
                                      filters: '{"regulated_producttype_id":3}'
                                  }
