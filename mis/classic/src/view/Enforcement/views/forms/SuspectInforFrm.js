  ...
  items: [
      ...
      listeners: {
        ...
        change: function (combo, newVal, oldval, eopts) {
          ...
          (is_registered = form.down("combo[name=is_registered]")),
            (certificate_no = form.down(
              "fieldcontainer[fieldLabel=Registered No]"
            )),
            (brand_name = form.down("textfield[name=brand_name]")),
            (common_name = form.down("textfield[name=common_name]")),
            (product_section_id = form.down(
              "combo[identity=product_section_id]"
            )),
            ...
            (is_facility_registered = form.down(
              "combo[name=is_facility_registered]"
            )),
    ...
    },
    {
      ...
      listeners: {
        ...
        change: function (combo, value) {
          var brand_name_txt = combo
            .up("form")
            .down("textfield[name=brand_name]");
          var common_name_txt = combo
            .up("form")
            .down("textfield[name=common_name]");
          var certificate_no = combo
            .up("form")
            .down("textfield[name=certificate_no]");
          var link_registered_product_btn = combo
            .up("form")
            .down("button[name=link_registered_product]");
          var section_id = combo.up("form").down("combo[name=section_id]");
          var prodclass_category_id = combo
            .up("form")
    ...
    //PREMISE
    {
      ...
      listeners: {
        ...
        change: function (combo, value) {
          var premise_name_txt = combo
            .up("form")
            .down("textfield[name=premise_name]");
          var premise_type = combo
            .up("form")
            .down("textfield[name=premise_type]");
          var permit_no = combo.up("form").down("textfield[name=permit_no]");
          var link_registered_premise_btn = combo
            .up("form")
            .down("button[name=link_registered_premise]");
