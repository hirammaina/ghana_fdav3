 ...
 */
Ext.define(
  "Admin.view.Enforcement.views.forms.MonitoringCompliance.LicenseInformationFrm",
  {
        ...
        listeners: {
          ...
          change: function (combo, value) {
            var link_registered_premise_btn = combo
              ...
              premise_name_txt = combo
                .up("form")
                .down("textfield[name=premise_name]"),
              premise_type_txt = combo
                .up("form")
            ...
            physical_address = combo
              .up("form")
              .down("textfield[name=physical_address]");
            postal_address = combo
              .up("form")
