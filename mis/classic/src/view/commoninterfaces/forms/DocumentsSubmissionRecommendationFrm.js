 ...
 */
Ext.define(
  "Admin.view.commoninterfaces.views.forms.common_forms.DocumentsSubmissionRecommendationFrm",
  {
    ...
    buttons: [
      {
        ...
        formBind: true,
        name: "btn_remarks",
        handler: "savesamplesubmissionremarks", //handler not in use instead listener in shared controller
      },
      {
        xtype: "button",
        text: "Clear",
