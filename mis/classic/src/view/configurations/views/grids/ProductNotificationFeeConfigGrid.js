...
Ext.define('Admin.view.configurations.views.grids.ProductNotificationFeeConfigGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'productnotificationfeeconfigfrm',
        winTitle: 'Product Notifications Fee Configurations',
        winWidth: '70%',
