Ext.define('Admin.view.configurations.views.forms.ProductNotificationFeeconfigFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'productnotificationfeeconfigfrm',
        ...
        items: [{
                    ...
                    config: {
                        ...
                        proxy: {
                            ...
                            extraParams: {
                                ...
                                filters: JSON.stringify({'module_id':28}),
                            }
                        }
                    },
                    isLoad: true
            ...
            listeners: {
                ...
                change: function(combo, newVal, oldVal, eopts){
                    ...
                    if(newVal == 1 || newVal == 19  || newVal == 8 || newVal == 9){
    ...
    dockedItems:[
        {
            ...
            items:['->',{
                    ...
                    storeID: 'productnotificationfeeconfiggridstr',
                    formBind: true,
                    ui: 'soft-purple',
