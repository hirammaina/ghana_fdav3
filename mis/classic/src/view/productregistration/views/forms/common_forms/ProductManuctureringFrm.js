 ...
 */
Ext.define(
  "Admin.view.productregistration.views.forms.common_forms.ProductManuctureringFrm",
  {
    ...
    items: [
      ...
      },
      {
        ...
        allowBlank: true,
        fieldLabel:
          "Has the Manufacturing Site been Inspected/Submitted Request for Inspection to the Ghana FDA",
        queryMode: "local",
        valueField: "id",
        displayField: "name",
        listeners: {
