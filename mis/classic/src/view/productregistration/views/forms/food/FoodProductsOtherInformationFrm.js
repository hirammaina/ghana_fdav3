 ...
 * on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.forms.food.FoodProductsOtherInformationFrm', {
    extend: 'Ext.tab.Panel',
    xtype: 'foodproductsotherinformationfrm',
    layout: {
    ...
    items: [{
        ...
        listeners: {
            beforerender: {
                ...
                config: {
                    ...
                    proxy: {
                        url: 'productregistration/onLoadproductNutrients',
                    }
                },
                isLoad: true
            }
        ...
        title: 'Inspection Undertaken In Other Countries'
        ...
        xtype: 'conductedproductclinicaltrialGrid', hidden: true,
