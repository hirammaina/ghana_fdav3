 ...
 */
Ext.define(
  "Admin.view.productregistration.views.forms.drugs.DrugsIngredientsFrm",
  {
    ...
    items: [
...

      {
        ...
        hidden: true,
        queryMode: "local",
        fieldLabel: "Common Name or Synonym",
        valueField: "id",
        displayField: "name",
        listeners: {
          afterrender: {
      ...
      {
        xtype: "combo",
        name: "can_cause_dependance_is_controlled",
        allowBlank: true,
        hidden: true,
        queryMode: "local",
        fieldLabel:
          "Is liable to cause dependence and/or listed in the UN lists of psychotropic and narcotic drugs?",
        valueField: "id",
        displayField: "name",
        listeners: {
          afterrender: {
...

      {
        xtype: "textfield",
        hidden: true,
        name: "quantity_dosage_unit",
        fieldLabel: "Quantity Per dosage unit ",
      },

      {
        xtype: "combo",
        name: "chemical_constituent_id",
        allowBlank: true,
        queryMode: "local",
        fieldLabel: "Chemical Constituent",
        hidden: true,
        valueField: "id",
        displayField: "name",
        listeners: {
