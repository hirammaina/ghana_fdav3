 ...
 */
Ext.define(
  "Admin.view.productregistration.views.sharedinterfaces.panels.food.FoodProductAuditingPnl",
  {
    ...
    items: [
      {
        ...
        items: [
...

          {
            ...
            margin: 5,
            items: [
              //   {  // leads to column errors to reinstate job on 16/02/24 after demo locked columns
