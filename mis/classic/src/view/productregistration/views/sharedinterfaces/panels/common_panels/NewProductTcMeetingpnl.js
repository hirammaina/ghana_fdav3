 ...
 */
Ext.define(
  "Admin.view.productregistration.views.sharedinterfaces.panels.common_panels.NewProductTcMeetingPnl",
  {
            ...
            items: [
              {
                ...
                beforeLoad: function () {
                  this.up("grid").fireEvent("refresh", this); //seems not working, no corresponding event listner
                },
              },
              "->",
              {
