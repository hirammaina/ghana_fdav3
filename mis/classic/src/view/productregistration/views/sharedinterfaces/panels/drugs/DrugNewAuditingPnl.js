 ...
 */
Ext.define(
  "Admin.view.productregistration.views.sharedinterfaces.panels.drugs.DrugNewAuditingPnl",
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          //     {
          //     xtype: 'transitionsbtn' // Job to reinstate later was just due to display issues
          // },
          {
