 ...
 */
Ext.define(
  "Admin.view.productregistration.views.sharedinterfaces.panels.drugs.DrugNewEvaluationPnl",
  {
    ...
    items: [
              ...
              },
              {
                ...
                listeners: {
                  beforerender: function (grid) {
                    ...
                    savegrid_screening_btn = grid.down(
                      "button[name=savegrid_screening_btn]"
                    );
      ...
      },
      {
        ...
        items: [
          //   {
          //     xtype: "transitionsbtn", //to reistate later due to large width Job 5/02/2024
          //   },
          {
