  ...
  features: [
    {
      ...
      groupHeaderTpl:
        '{[values.rows[0].data.workflow_stage]}, Sub-Process: {[values.rows[0].data.sub_module]}, [{rows.length} {[values.rows.length > 1 ? "Items" : "Item"]}]',
  ...
  columns: [
    ...
    },
    {
      ...
      renderer: function (value, metaData) {
        if (value != "" && value != null) {
          metaData.tdStyle = "color:white;background-color:#2e8B57";
          return "Has Analysis";
        }
        return "N/A";
      },
