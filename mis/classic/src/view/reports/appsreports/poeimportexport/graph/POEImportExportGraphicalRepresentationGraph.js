Ext.define('Admin.view.reports.appsreports.importexportreport.graph.POEImportExportGraphicalRepresentationGraph', {
    ...
    dockedItems: [{
        ...
        items: [{
             ...
             items: [{
                    ...
                    listeners: {
                        beforerender: {
                            ...
                            config: {
                                ...
                                proxy: {
                                   url: 'newreports/getPOEImportExportSummaryCartesianReport',
                                    extraParams: {
                                       module_id: 4
                                    }
                                }
                    ...
                    sprites: [{
                        type: 'text',
                        text: ' POE Import & Export Applications Summary Report Chart',
                        fontSize: 16,
                        width: 100,
                        height: 30,
