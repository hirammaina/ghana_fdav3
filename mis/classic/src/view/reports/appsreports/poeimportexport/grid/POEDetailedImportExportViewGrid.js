Ext.define('Admin.view.reports.appsreports.importexportreport.grid.POEDetailedImportExportViewGrid', {
 extend: 'Ext.grid.Panel',  
   scroll: true,
   width: '100%',
    xtype: 'poedetailedimportexportviewgrid',
   layout: 'fit',
   store: 'poespreadsheetieapplicationcolumnsstr',
