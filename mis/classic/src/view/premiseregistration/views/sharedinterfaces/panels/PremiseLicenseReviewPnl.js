 ...
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.PremiseLicenseReviewPnl', {
    extend: 'Ext.panel.Panel',
    title: 'License Review Applications',
    xtype: 'premiselicensereviewpnl',
    layout: 'border',
    defaults: {
        split: true,
    },
    ...
    items: [
        ...
        },
        {
            title: 'Applications',
            region: 'center',
            xtype: 'premiselicensereviewmeetinggrid',//productReviewTCMeetingGridpremiseReviewTCMeetingGrid
            dockedItems: [{
                xtype: 'toolbar',
                ui: 'footer',
                scrollable: true,
